...
{
    public partial class InterfaceCasier2 : UserControl
    {
        ...
        {
            UserControl2.command.Remove("RACK 1");
        ...
        private void InterfaceCasier2_Load(object sender, EventArgs e)
        {
            Do_checked();
        }
        ...
        public void Nextstep()
        {
            ...
            if (!panelColor.Equals("") && !heightValue.Equals(0))
            {
                ...
                if (DoorSelect.Checked)
                {
                    ...
                    if (!doorColor.Equals(""))
                    {
                        UserControl2.command.Add("RACK 2", rack);
